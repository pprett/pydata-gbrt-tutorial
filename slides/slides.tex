...
%     \begin{tabular}{| l | l | r |}
%     \hline
%        & Train time [s] & Test time [ms] \\ \hline
%     c-style & 0.006 & 0.11\\
%     fortran-style & 192.0 & 439.00 \\
%     \hline
%     \end{tabular}
% \end{center}
...
% TODO
% Tipps & Tricks: fortran layout, dtype, pickling, categorical variables, memory efficiency
% Benchmarks vs. R GBM
% Advantages / Disadvantages of GBRT
%  - Handling (heterogenous) features (transformations, categoricals)
%  - Robust to irrelevant variables; and outliers in response
%  - Model interpretation
%  - Flexible (non-parametric - can model any relation between fx and response)
%    - High predicitve accuracy
% Comparision to other methods (RF)
%  - RF "easier" to train - much less HPs much less sensitive
%  - GBRT fine-grained control of model complexity
%  - regression: RF averages responses of T (mean of means); GBRT set of possible outputs is larger.
%  - Difficult so say in general
% When does it work?!
% Pseudo-code
